...
private:
  ...
  ////////////typedef tf::implementation::llvm_vecsmall::AlignedCharArrayUnion<T> U;
...
void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
  ...
  size_t NewCapacity = size_t(
      tf::implementation::llvm_vecsmall::detail::NextPowerOf2(CurCapacity + 2));
...
public:
  ...
  /*
    ...
    tf::implementation::llvm_vecsmall::iterator_range<RangeTy> &R) :
...
template <typename T>
inline void swap(tf::implementation::llvm_vecsmall::SmallVectorImpl<T> &LHS,
                 tf::implementation::llvm_vecsmall::SmallVectorImpl<T> &RHS) {
  LHS.swap(RHS);
}

/// Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(tf::implementation::llvm_vecsmall::SmallVector<T, N> &LHS,
                 tf::implementation::llvm_vecsmall::SmallVector<T, N> &RHS) {
  LHS.swap(RHS);
}
} // namespace std
